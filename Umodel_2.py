...
def make_test_set(train_start_date, train_end_date,user,ful_action,sub_action):
    dump_path = './cache/bu10525model_2_u_test_set_%s_%s.csv' % (train_start_date, train_end_date)
    if os.path.exists(dump_path):
        actions = pd.read_csv(dump_path)
    else:
...
def make_train_set(train_start_date, train_end_date, test_start_date, test_end_date,user,ful_action,sub_action):
    dump_path = './cache/bu10525model_2_u_train_set_%s_%s_%s_%s.csv' % (train_start_date, train_end_date, test_start_date, test_end_date)
    if os.path.exists(dump_path):
        actions = pd.read_csv(dump_path)
    else:
...
result.to_csv('./sub/Umodel_2.csv',index=False,index_label=False )
print("U model 2 finish  part_5")
